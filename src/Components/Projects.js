  ...
  return (
    <div className="projects" id="projects">
      <div className="project" id="project">
        <Link to="https://jewellery-six.vercel.app" target="_blank">
          <div className="project-photo11"></div>
        </Link>
        <div className="project-description">
          Jeweluxe, an elegant online platform where you can explore and
          ...
          <div className="project-end">
            <Link to="https://github.com/levy-237/jewellery" target="_blank">
